...
public class Camion implements Vehiculo{
    ...
    al llamar acelerar() se ejecutará esta versión si el objeto es un Camion. Cada subclase
    implementa el método a su manera, permitiendo que un mismo mensaje se comporte distinto
    según el vehículo que sea.*/
    @Override
    public void acelerar() {
        System.out.println("El camión esta acelerando...");
    }

    //Implementamos el método frenar
    /*Esto también muestra polimorfismo, porque si usamos una referencia del tipo Vehiculo
    al llamar a frenar() se ejecutará esta versión si el objeto es un Camion. Cada subclase
    implementa el método a su manera, permitiendo que un mismo mensaje se comporte distinto
    según el vehículo que sea.*/
    @Override
    public void frenar() {
       System.out.println("El camión esta frenando...");
    }
